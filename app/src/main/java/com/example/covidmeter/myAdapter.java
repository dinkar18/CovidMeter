...
public class myAdapter extends ArrayAdapter<CountryModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imageViewFlag = view.findViewById(R.id.countryFlagImage);

        textViewCountryName.setText(countryModelListFiltered.get(position).getCountry());
        Glide.with(context).load(countryModelListFiltered.get(position).getFlag()).into(imageViewFlag);
